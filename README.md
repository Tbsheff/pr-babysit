...
```bash
curl -fsSL https://github.com/Tbsheff/pr-babysit/releases/download/v0.1.5/install.sh | bash
```
...
```bash
npm install -g https://github.com/Tbsheff/pr-babysit/releases/download/v0.1.5/pr-babysit-0.1.5.tgz
